...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_l1', type=float, default=1.0, help="L1損失関数の係数値")
    ...
    for epoch in tqdm( range(args.n_epoches), desc = "epoches" ):
        for iter, inputs in enumerate( tqdm( dloader_train, desc = "minbatch iters" ) ):
            ...
            if( step == 0 or ( step % args.n_diaplay_step == 0 ) ):
                ...
                print( "step={}, loss_G={:.5f}, loss_l1={:.5f}".format(step, loss_G.item(), loss_l1.item() ) )
            ...
            if( step != 0 and ( step % args.n_display_valid_step == 0 ) ):
                loss_G_total, loss_l1_total = 0, 0
                n_valid_loop = 0
