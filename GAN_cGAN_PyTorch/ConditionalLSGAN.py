    ...
    def fit( self, dloader, n_sava_step = 5 ):
        ...
        for epoch in tqdm( range(self._n_epoches), desc = "Epoches" ):
            ...
            for (images,targets) in tqdm( dloader, desc = "minbatch process in DataLoader" ):
                ...
                #plt.imshow( y_real_image_label[0,0,:,:] )
                #plt.show()
                #====================================================
                # 識別器 D の fitting 処理
                #====================================================
            ...
            if( epoch % n_sava_step == 0 ):
                ...
                save_image( tensor = images, filename = "cLSGAN_Image_epoches{}_iters{}.png".format( epoch, iterations ) )

                for i in range( self._n_classes ):
                    images_i = self.generate_fixed_images_with_lable( n_samples = 64, y_label = i, b_transformed = False )
                    save_image( tensor = images_i, filename = "cLSGAN_Image{}_epoches{}_iters{}.png".format( i, epoch, iterations ) )
