...
if __name__ == '__main__':
    ...
    parser.add_argument("--exper_name", default="CGAN_test", help="実験名")
    ...
    for step in tqdm( range(args.n_samplings), desc = "Samplings" ):
        ...
        # 出力画像の生成＆保存
        #---------------------
        save_image( tensor = G_z, filename = os.path.join(args.results_dir, args.exper_name) + "/fake_image_ylabel{}_seed{}_batchAll.png".format( args.y_label, seed ) )
        seed += 1
        n_print -= 1
